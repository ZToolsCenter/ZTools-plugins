(function(c) {
	...
	var fP = {
		...
		fR = {
			'get': function(g2) {
        //let ret = JSON.parse(window.dbGet(g2)) || {}
				let ret = aP['parse']((ae['isMobi'] ? V['root']['localStorage']['getItem'](g2) : fQ['get'](g2)) || '{}');
        console.log('51la.get', g2, ret)
        return ret
			},
			'set': function(g3, g4, g5, g6) {
        console.log('51la.set', g3, g4, g5, g6)
        //window.dbPut(g3, g4)
        //return true
				let ret = ae['isMobi'] ? V['root']['localStorage']['setItem'](g3, g4) : fQ['set'](g3, g4, g5, g6);
        // console.log('51la.set', g3, g4, g5, g6, ret)
        return ret;
			}
		},
		fS = {
