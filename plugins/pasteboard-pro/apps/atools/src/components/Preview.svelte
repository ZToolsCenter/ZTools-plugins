...
<style>
  ...
  .preview-body{display:grid;min-height:0;grid-template-rows:minmax(150px,1fr) auto;gap:10px;overflow:hidden}.media{display:grid;place-items:center;min-height:0;margin:14px 0;overflow:hidden;border:1px solid var(--pb-line);border-radius:15px;background:rgba(0,0,0,.08)}.preview-body .media{margin-bottom:0}.media img{display:block;width:auto;height:auto;max-width:100%;max-height:100%;object-fit:contain}.media object{display:block;width:100%;height:100%;min-height:180px;border:0}.ocr-text{max-height:110px;margin:0;padding:10px;border:1px solid var(--pb-line);border-radius:12px;background:color-mix(in srgb,var(--pb-glass) 72%,transparent)}
